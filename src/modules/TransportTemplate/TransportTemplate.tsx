    ...
    const Menu = ({ id }: { id: number }) => {
        return (
            <div className={s.menu}>
                <svg className={s.svg} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className={s.svg} onClick={() => handleRemove(id)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className={s.wrapper}>
            <div className={s.list}>
                {transportTemplate.map((current, index) => (
                    <div key={current.id} className={s.list__wrapper}>
                        ...
                        >
                            ...
                            <div className={s.item__menu}>
                                <svg onClick={(e) => windowSwipe && handleClick(e, index) } className={s.item__svg} width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
